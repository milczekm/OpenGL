...
public class Piramida {
    ...
    //obracanie piramidy za pomoc� strza�ek
    ...
    static IntBuffer bufferI2 = BufferUtils.createIntBuffer(3);
    static IntBuffer bufferI3 = BufferUtils.createIntBuffer(3);
    static IntBuffer bufferI4 = BufferUtils.createIntBuffer(3);
    static IntBuffer bufferI5 = BufferUtils.createIntBuffer(3);

    static FloatBuffer bufferV = BufferUtils.createFloatBuffer(15);
    ...
    static void display() {
        ...
        float x = (float) Math.sqrt(2) * 0.5f;

        glNormal3f(0, -1, 0);  //podstawa
        glDrawElements(GL_QUADS, bufferI1);

        glNormal3f(0, x, x);  //przednia
        glDrawElements(GL_TRIANGLES, bufferI2);

        glNormal3f(x, x, 0);  //prawa
        glDrawElements(GL_TRIANGLES, bufferI3);

        glNormal3f(0, x, -x);  //tylna
        glDrawElements(GL_TRIANGLES, bufferI4);

        glNormal3f(-x, x, 0); //lewa
        glDrawElements(GL_TRIANGLES, bufferI5);
