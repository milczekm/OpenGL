...
public class JednaPlanetaWokolSlonca {
    ...
    static void display() {
        ...
        glColor3f(1f, 1f, 0f);
        glTranslatef(4, 0, 0);
        kula(promienk4);        //slonce

        glColor3f(0f, 0f, 0f);
        glRotatef(120, 1, 0, 0);
        kulaL(promienk4); //kula w linie
        glPopMatrix();
